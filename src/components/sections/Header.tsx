...
export default function Header() {
  return (
    ...
    >
      ...
      <div className="absolute top-50 right-35 z-0">
        <Image src="/images/shape-3.png" alt="" width={120} height={120} />
      </div>
      <div className="absolute bottom-16 left-5 z-0">
        <Image src="/images/shape-2.png" alt="" width={55} height={55} />
      </div>
      <div className="absolute bottom-30 right-14 z-0">
        <Image src="/images/shape-4.png" alt="" width={30} height={30} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 flex-wrap mt-2">
            <Link href="#course">
              <button className="relative overflow-hidden bg-orange-500 text-white font-bold px-10 py-5 rounded-sm group uppercase tracking-wider text-sm">
                <span className="relative z-10">Explore Courses</span>
                <span className="absolute inset-y-2 right-5 w-10 bg-slate-900 rounded-sm transition-all duration-500 ease-in-out group-hover:w-full" />
              </button>
            </Link>

            <Link href="#contact">
              <button className="relative overflow-hidden bg-slate-900 text-white font-bold px-10 py-5 rounded-sm group uppercase tracking-wider text-sm">
