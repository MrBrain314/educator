...
export default function Event() {
  return (
    <section id="event" className="w-full py-16 lg:py-24 bg-slate-50">
          ...
          <ul className="flex flex-col gap-4">
            {events.map((event) => (
              <Link
                key={event.id}
                href={event.href}
                className="flex items-center gap-6 bg-white rounded-xl p-5 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <h3 className="font-bold text-slate-800 hover:text-orange-500 transition-colors text-base">
                    {event.title}
                  </h3>
                </div>
              </Link>
